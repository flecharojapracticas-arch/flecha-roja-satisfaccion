...
const surveysRouter = require('./routes/surveys'); // 🔑 ADICIÓN 1: Agregamos el import para el dashboard futuro
...
// *****************************************************************
// 🔑 ADICIÓN 2: Montaje del dashboard (solo para el futuro)
// *****************************************************************
...
        destinoFinal: receivedData.destinoFinal || "",
        // 🚀 CORRECCIÓN CRÍTICA: Se añade el campo tipoServicio para que se guarde.
...
        especificarMotivo: receivedData.especificarMotivo || "",
        ...
        // El campo 'validado' ya está en tu output, por lo que lo agregamos para consistencia.
        validado: receivedData.validado || "PENDIENTE", 
        
        // Datos automáticos
